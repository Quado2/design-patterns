...
//    exampleSerialization();
  ...
  public static void exampleSerialization() throws IOException, ClassNotFoundException, InvocationTargetException {
    ...
    LazySingleton desirializedLazySingleton = (LazySingleton) objectInputStream.readObject();
    objectInputStream.close();
    System.out.println("Object 1: " + lazySingleton.hashCode());
    System.out.println("Object 2: " + desirializedLazySingleton.hashCode());
  ...
  public static void exampleReflection() throws InvocationTargetException, InstantiationException, IllegalArgumentException, IllegalAccessException {
    Constructor[] constructors = LazySingleton.class.getDeclaredConstructors();

    //Since we have only one contructor, we can take it using the first index
