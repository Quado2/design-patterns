...
public class Main {
  ...
  public static void main(String[] args) {
    Gown gucciGown = new Gown(new GucciBrand());
    Gown lvGown = new Gown(new LVBrand());

    Trouses lvTrouses = new Trouses(new LVBrand());

    System.out.println(lvGown.buy());
    System.out.println(gucciGown.buy());
    System.out.println(lvTrouses.buy());
